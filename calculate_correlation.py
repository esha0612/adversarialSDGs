...
class CorrelationAnalyzer:
    ...
    def extract_responses(self, all_game_data):
        ...
        - table_talk: Each player's table talk statement per day
        ...
        for game in all_game_data:
            ...
            for talk in game.get('table_talk', []):
                day_number = talk.get('day_number', 0)
        ...
        print(f"Extracted {len(responses)} table talk responses from all games")
        return responses
    ...
    def run_full_analysis(self):
        ...
        # Save results to CSV
        print("\n=== Saving Results ===")
        valid_df.to_csv('correlation_analysis_aggregated_user_branch2.csv', index=False)
        print("Aggregated results with user values saved to: correlation_analysis_aggregated_user_branch2.csv")
        ...
        summary_df.to_csv('correlation_analysis_summary_user_branch2.csv', index=False)
        print("Summary results saved to: correlation_analysis_summary_user_branch2.csv")
